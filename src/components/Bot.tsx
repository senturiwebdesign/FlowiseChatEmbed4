        ...
        {props.showTitle ? (
          ...
          >
            ...
            <Show when={props.title}>
              ...
              <span style="bot_subtitle"><img src="https://whispered.ai/wp-content/uploads/2024/05/book-solid.png" alt="Icon" style="width: 12px; height: 12px; margin-right: 5px; vertical-align: middle;"/>Ontwikkeling in vogelvlucht</span>
            </Show>
            <div style={{ flex: 1 }} />
            <DeleteButton
